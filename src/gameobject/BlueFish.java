...
public class BlueFish extends Animal{
	...
	public BlueFish(int xPos, int yPos, int depth, int xSize, int ySize) {
		...
		this.setSpeed(10);
		this.setWeight(250);
		this.setQuestion(new Question("Female Blue Marlins can weigh up to 3000 pounds", "How much can a female Blue Marlin weigh?", 
				"up to 3000 lbs", "up to 30 lbs", "up to 300 lbs", "up to 3 lbs"));
