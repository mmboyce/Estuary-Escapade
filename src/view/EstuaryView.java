...
public class EstuaryView extends View {
	...
	// constructs the estuaryview by populating an arraylist with game objects and
	// then iterating over it to extract the images for animation
	// params:
	// int width: width of the view window
	// int height: height of the view window
	// MouseListener m: mouse listener to verify clicks
	// ArrayList<GameObject> objects: an arraylist of game objects, mostly estuary
	// animals, to load the images.
